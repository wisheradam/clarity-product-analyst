...
"@
    ...
    if ($FullPrompt.Length -gt 28000) {
        throw "Prompt is too large for the safe Windows command-line path: $($FullPrompt.Length) characters."
    }
    ...
    $ResponseLines = & $copilot.Source @CopilotArgs
